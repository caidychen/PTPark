...
typedef NS_ENUM(NSInteger, MJRefreshState) {
    ...
    /** 进入二楼 */
    MJRefreshStateSecondFloor,
    /** 正在进入二楼 */
    MJRefreshStateSecondFloorEntering
};
...
/** 进入二楼的回调 */
typedef void (^MJRefreshComponentEnterSecondFloorBlock)();
...
/** 进入二楼的回调 */
@property (copy, nonatomic) MJRefreshComponentEnterSecondFloorBlock enterSecondFloorBlock;
